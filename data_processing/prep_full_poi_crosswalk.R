# Title: prep_full_poi_crosswalk.R
# Author: Emma Castro
# Purpose: This script combines the Core Places SafeGraph data (saved across 5 csv files) and creates a crosswalk that maps
# SafeGraph place_id to it's associated top category for all POIs (not just bars and restaurants). It should only need to be  
# run once. The crosswalk will be saved here: \mnt\share\scratch\users\ems2285\thesis\intermediate\poi_full_crosswalk.csv
...
# Output
fwrite(poi_info, paste0(out_dir,'poi_full_crosswalk.csv'))
