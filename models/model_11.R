...
model_11 <- function(dataset, w, d, use_param_uncertainty = TRUE){
  ...
  ids <- data.table(model="model_11", location_id = new_dt$location_id, time_id = new_dt$time_id, sigma = sigma_hat)
